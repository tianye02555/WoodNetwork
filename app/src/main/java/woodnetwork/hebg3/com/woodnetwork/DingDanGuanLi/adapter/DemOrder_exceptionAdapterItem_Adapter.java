...
import woodnetwork.hebg3.com.woodnetwork.DingDanGuanLi.bean.OrderBuyerDemExceptionList_listItem_productsItem;
...
public class DemOrder_exceptionAdapterItem_Adapter extends BaseAdapter {
    private Context context;
    private List<OrderBuyerDemExceptionList_listItem_productsItem> list;
    private  String seller;

    public DemOrder_exceptionAdapterItem_Adapter(Context context, List<OrderBuyerDemExceptionList_listItem_productsItem> list, String seller) {
    ...
    public View getView(int position, View contentView, ViewGroup viewGroup) {
        ...
        if (null == contentView) {
            ...
            holder = (DemOrder_exceptionAdapterItem_Adapter.ViewHodler) contentView.getTag();
        }
