...
import woodnetwork.hebg3.com.woodnetwork.DingDanGuanLi.bean.OrderBuyerDemPayList_listItem_productsItem;
...
public class DemOrder_payAdapterItem_Adapter extends BaseAdapter {
    private Context context;
    private List<OrderBuyerDemPayList_listItem_productsItem> list;
    private  String seller;

    public DemOrder_payAdapterItem_Adapter(Context context, List<OrderBuyerDemPayList_listItem_productsItem> list, String seller) {
