...
public class MyOrder_exceptionAdapterItem_Adapter extends BaseAdapter {
    private Context context;
    private List<OrderBuyerProExceptionList_listItem_productsItem> list;
    private  String seller;

    public MyOrder_exceptionAdapterItem_Adapter(Context context, List<OrderBuyerProExceptionList_listItem_productsItem> list, String seller) {
