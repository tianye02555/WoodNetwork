...
import woodnetwork.hebg3.com.woodnetwork.DingDanGuanLi.bean.OrderBuyerProPayList_listItem_productsItem;
...
public class MyOrder_payAdapterItem_Adapter extends BaseAdapter {
    private Context context;
    private List<OrderBuyerProPayList_listItem_productsItem> list;
    private  String seller;

    public MyOrder_payAdapterItem_Adapter(Context context, List<OrderBuyerProPayList_listItem_productsItem> list, String seller) {
