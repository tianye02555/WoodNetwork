...
public class OrderException_yiChangXinXi_listAdapter extends BaseAdapter {
    private Context context;
    private List<ExceptionList_exceptionItem> list;
    private OrderException_yiChangXinXi_gridAdapter adapter;
    public OrderException_yiChangXinXi_listAdapter(Context context, List<ExceptionList_exceptionItem> list) {
