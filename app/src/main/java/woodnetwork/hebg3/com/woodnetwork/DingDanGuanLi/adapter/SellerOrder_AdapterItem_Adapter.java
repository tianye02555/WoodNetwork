...
import woodnetwork.hebg3.com.woodnetwork.DingDanGuanLi.bean.OrderSellerList_listItem_productsItem;
...
public class SellerOrder_AdapterItem_Adapter extends BaseAdapter {
    private Context context;
    private List<OrderSellerList_listItem_productsItem> list;
    private  String seller;

    public SellerOrder_AdapterItem_Adapter(Context context, List<OrderSellerList_listItem_productsItem> list, String seller) {
