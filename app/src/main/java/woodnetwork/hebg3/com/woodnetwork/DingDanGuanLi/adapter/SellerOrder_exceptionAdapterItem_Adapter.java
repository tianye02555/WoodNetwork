...
public class SellerOrder_exceptionAdapterItem_Adapter extends BaseAdapter {
    private Context context;
    private List<OrderSellerExceptionList_listItem_productsItem> list;
    private  String seller;

    public SellerOrder_exceptionAdapterItem_Adapter(Context context, List<OrderSellerExceptionList_listItem_productsItem> list, String seller) {
