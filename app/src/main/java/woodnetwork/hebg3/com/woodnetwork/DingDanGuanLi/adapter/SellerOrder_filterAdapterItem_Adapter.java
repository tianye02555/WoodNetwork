...
public class SellerOrder_filterAdapterItem_Adapter extends BaseAdapter {
    private Context context;
    private List<OrderSellerFilterList_listItem_productsItem> list;
    private  String seller;

    public SellerOrder_filterAdapterItem_Adapter(Context context, List<OrderSellerFilterList_listItem_productsItem> list, String seller) {
