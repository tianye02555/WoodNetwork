...
public class WoodInfoAdapter extends BaseAdapter {
    private Context context;
    private List<WoodSpecifications> list;

    public WoodInfoAdapter(Context context, List<WoodSpecifications> list) {
