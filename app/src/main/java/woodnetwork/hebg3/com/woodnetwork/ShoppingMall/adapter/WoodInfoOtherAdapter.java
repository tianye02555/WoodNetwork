...
public class WoodInfoOtherAdapter extends BaseAdapter {
    private Context context;
    private List<ProductSellerInfo_attributeItem> list;

    public WoodInfoOtherAdapter(Context context, List<ProductSellerInfo_attributeItem> list) {
