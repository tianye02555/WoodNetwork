...
public class DmandBuyerInfoModel implements DmandBuyerInfoModelInterface {
    ...
    @Override
    public void getDmandBuyerData(Object object, OnServiceBaceInterface onServiceBaceInterface) {
        this.onServiceBaceInterface = onServiceBaceInterface;
        ClientParams params = new ClientParams();
        params.http_method = ClientParams.HTTP_GET;
        params.getMethod = ServiceInterfaceCont.DEMANDBUYERINFO;
        params.GETTYPE = "1";
        params.params = CommonUtils.getParamString(object);
        new NetTask(handler.obtainMessage(), params, DemandBuyerInfo.class).execute();
    }
}
