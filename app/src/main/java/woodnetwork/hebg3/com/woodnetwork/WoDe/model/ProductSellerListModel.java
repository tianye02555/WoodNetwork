...
public class ProductSellerListModel implements ProductSellerListModelInterface {
    ...
    @Override
    public void getProductSellerListData(Object object, OnServiceBaceInterface onServiceBaceInterface) {
        this.onServiceBaceInterface = onServiceBaceInterface;
        ClientParams params = new ClientParams();
        params.http_method = ClientParams.HTTP_GET;
        params.getMethod = ServiceInterfaceCont.PRODUCTSELLERLIST;
        params.GETTYPE = "1";
        params.params = CommonUtils.getParamString(object);
        new NetTask(handler.obtainMessage(), params, ProductSellerList.class).execute();
    }
}
